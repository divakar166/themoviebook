...
<body>
	...
	<div class="theatre">
		...
		<div class="container" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif;margin-top:5rem;">
		<?php
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="theatre_image">
					<img src="<?php echo $row_theatre['image']?>" class="theatre_image">
				</div>
			</div>
			<div class="wrp col-sm-4">
				...
				<table class="theatre_details">
					...
					<tr>
						<td>Telephone : </td>
						<td><a href="tel:<?php if($row_theatre['telephone']== 0){ echo "N/A";}else{echo $row_theatre['telephone'];}?>"><?php if($row_theatre['telephone']== 0){ echo "N/A";}else{echo $row_theatre['telephone'];}?></a> </td>
					</tr>
				</table>
			</div>
		</div>
		...
		<?php
			...
			<div class="row">
					...
					<div class="col-md-3 col-sm-4">
						<div class="movie">
							<a href="movie.php?movie_id=<?php echo $row_nowshowing['movie_id']; ?>"><img src="data:image/jpeg;base64,<?php echo base64_encode(file_get_contents($row_nowshowing['poster']))?>" class="movie_image"></a>
