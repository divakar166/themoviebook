...
<table id="showtimes_table" class="table table-striped table-bordered table-sm">
    <thead class="grey lighten-1">
        <tr>
            ...
            <th class="hide" id="show_id_column">Show ID</th>
            <th class="th-sm">Movie</th>
            <th class="th-sm">Theatre</th>
            ...
            if($result->num_rows>0){
                ...
                while($row=$result->fetch_assoc()){
                    ...
                    echo "<tr>";
                        ...
                        echo "<td class='hide' id='show_id_column'>{$row['show_id']}</td>";
