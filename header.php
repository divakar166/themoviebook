<div class="header_wrapper">    
    <div class="main_menu_wrapper">
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg_transparent" role="navigation">
                    ...
                    <div class="col-lg-11">
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            ...
                            <ul class="navbar-nav navbar-right">
                                ...
                                <?php } else { ?>
                                <li class="item-9"><a class="nav-link" href="login.php">LOG IN</a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
...
<script>
    window.onscroll = function(){
        if (window.pageYOffset > 50){
            $(".navbar").removeClass("bg_transparent");
            $(".navbar").addClass("bg-black");
        }
        else{
            $(".navbar").addClass("bg_transparent");
