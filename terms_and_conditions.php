    ...
    <div class="terms_and_conditions">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            ...
            <div>
                ...
                <p>&nbsp;</p>
                <p>This website –  is owned and operated by Team GenetriX in the name of theMovieBook Private Limited.</p>
                ...
                <p>If you are not agreeable with these Terms of Use, kindly refrain from accessing and using the service provided by .</p>
                <p>Registering with and/or the use of the  services and products, including and without limitation the  web site, purchase of movie and/or DVD –CD purchasing online, and other similar products or services offered by , is indicative that you have read and understood the terms and conditions set forth below and agree to be legally bound by the said terms and conditions.<br />We reserve the right to change these terms of use from time to time by posting the new version on the website. It is your responsibility to check regularly this page for the latest terms and conditions.<strong></strong></p>
                <p>&nbsp;</p>
                <p style="font-size: 18px;">03. Permitted Use</p>
                <p>&nbsp;</p>
                <p>The service provided by   is for personal &amp; non-commercial use.</p>
                <p>You hereby agree that you will not duplicate, download, publish, modify, distribute and/or use any material included in  for any purpose, unless and otherwise you have obtained prior written permission from .<br /><br />You also agree that you will not use the services provided by  for any purpose other than to subscribe and review the information in  and purchase movie tickets and /or DVD – CD’s for your personal use.</p>
                <p>Use of the material and / or content contained in  for any purpose not set forth in these Terms of Use is strictly prohibited.<strong></strong></p>
                <p>&nbsp;</p>
                ...
                <p>&nbsp;</p>
                <p><strong>Note:</strong> You should have made your bookings through your theMovieBook account in order to make amendments in bookings. A certain amount will be charged according to the type of amendment and ticket price.</p>
                <p>Tickets can be cancelled by publishing the ticket on theMovieBook website by entering your ticket number in the publish ticket prompt menu of your bookings page. Refunds will be made only if the published ticket is sold out to another customer. Seats can be changed even after bookings were made by entering your ticket number in the seat change prompt menu of your bookings page. These amendments are valid until 2 hours before the time of the booked movie show.</p>
                ...
                <p> reserves the right to NOT to screen a movie ( and due to unavoidable circumstances) and in such cases refunds will be made to valid ticket holders.<strong></strong></p>
                <p>&nbsp;</p>
                ...
                <p>&nbsp;</p>
                <p>It is your responsibility to ensure that you carry the original confirmation receipt to theatre with you.<strong></strong></p>
                <p>&nbsp;</p>
                <p style="font-size: 18px;">09. Registration, Accounts and Passwords</p>
                <p>&nbsp;</p>
                <p>You agree to provide accurate, current and complete data about yourself on the  registration form and keep your profile updated with accurate, current and complete information.</p>
                <p>You also understand that failure to maintain accurate, current and complete information in your profile will give  adequate cause to suspend or terminate your use of its services.</p>
                <p>Upon registration you will receive a User Name and Password. Continued maintenance of confidentiality with regard to your User Name and Password will always remain your sole responsibility. You agree to bring to the immediate notice of  any unauthorized use of your password or account or any other breach of security. You also agree to ensure that you exit from your account each time you use . Access to and use of password protected and/or secure areas of  is restricted to its registered users only. Unauthorized attempts to access these areas of  may be subject to prosecution.<strong></strong></p>
                <p>&nbsp;</p>
                <p style="font-size: 18px;">10. Privacy Policy</p>
                <p>&nbsp;</p>
                <p>Your use of  is governed by its Privacy Policy. You hereby agree to  collection, use and sharing of your information as set forth in the  Privacy Policy.<strong></strong></p>
                <p>&nbsp;</p>
                <p style="font-size: 18px;">11. User Conduct</p>
                <p>&nbsp;</p>
                <p>You agree that you will not use  to upload, post, or otherwise distribute or facilitate distribution of any material that is</p>
                ...
                <li>Impersonates any person or entity, including any employee or representative of ; or</li>
                <li>Violates any applicable law or these Terms of Use.</li>
                </ul>
                <p><br />You also agree that you will not collect information about third parties via  or use any such information for the purpose of transmitting and / or facilitating transmission of unauthorized or unsolicited advertising, junk or bulk e-mail, chain letters, or any other form of unauthorized solicitation.<br /><br />You agree that you will not engage in the systematic retrieval of data or other content from  to create or compile, directly or indirectly, a collection, compilation, database or directory, without ’s prior written consent. You agree not to take any actions for the purpose of manipulating or distorting, or that may undermine the integrity and accuracy of, any ratings or reviews of any movie or other entertainment program, service or product that may be presented by .<strong></strong></p>
                <p>&nbsp;</p>
                <p style="font-size: 18px;">12. Copyrights</p>
                <p>&nbsp;</p>
                <p> respects the intellectual property of others, and we ask our users to do the same. If notified of allegedly infringing, defamatory, damaging, illegal, or offensive content,  may, in its sole discretion, investigate the allegation and/or edit, remove or request the removal of such content. Notwithstanding the foregoing,  does not ensure that any such content will be edited or removed.  may terminate the accounts of users who infringe the intellectual property rights of others.<strong></strong></p>
                <p>&nbsp;</p>
                <p style="font-size: 18px;">13. Proprietary Rights</p>
                <p>&nbsp;</p>
                <p> owns all right, title and interest in and to this service and all materials and content contained in , including, without limitation, all content, site design, logos, button icons, images, digital downloads, data compilations, text, and graphics are protected by copyright, trademark and other intellectual property laws. Any unauthorized use of the materials provided as part of the  is strictly prohibited.<br /><br />Permission is granted to individual consumers to electronically copy and to print hard copy portions of the Site solely for personal use. Any other use of materials on the site, including reproduction for purposes other than those noted above, modification, distribution, or republication, any form of data extraction or data mining, or other commercial exploitation of any kind, without prior written permission of an authorized officer of  is strictly prohibited. You agree that you will not use any robot, spider, other automatic device, or manual process to monitor or copy our Web pages or the content contained therein without prior written permission of an authorized officer of .</p>
                <p>&nbsp;</p>
                <p style="font-size: 18px;">14. Termination</p>
                <p>&nbsp;</p>
                <p>In its sole and absolute discretion, with or without notice to you  may</p>
                <ul class="page_bullet">
                <li>Suspend or terminate your use of the services provided by ,</li>
                <li>Terminate your account at ;</li>
                </ul>
                <p>You may terminate your account by informing in writing to  about your decision to terminate your account and  will de-activate your account upon receipt of such notification.   shall not be liable to you or any third party for any claims or damages arising out of any termination or suspension of its service.<strong></strong></p>
                <p>&nbsp;</p>
                <p style="font-size: 18px;">15. General</p>
                <p>&nbsp;</p>
                <p>The Terms of Use and the relationship between you and  shall be governed by the laws of the Republic of Sri Lanka. The section titles in these Terms of Use are for convenience only and have no legal or contractual effect.</p>
                <p>These terms and conditions are binding upon and shall ensure the benefit of both parties, their respective successors, heirs, executor, administrators, personal representatives and permitted assigns.<br />You shall not assign your rights or obligations hereunder without ’s prior written consent. <br /><br /><br /></p> 
            </div>
        </div>
    </div>
