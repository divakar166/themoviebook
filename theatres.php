...
<html lang="en">
  ...
  <body>
    ...
    <!--theatres Body - Start-->
    <div class="theatres" style="margin-top:5rem;">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
			...
			<div class="theatres">
				...
				<div class="row">
					...
					<div class="theatre">
						<img src="<?php echo $row_theatres['image']?>" class="theatre_image">
						<div class="theatre_bottom_wrap">
							...
							<table class="theatre_details">
								...
								<tr>
										<td>Telephone : </td>
										<td><a href="<?php if($row_theatres['telephone'] == 0){echo 'N/A';}else{ echo "tel:".$row_theatres['telephone']; }?>"><?php if($row_theatres['telephone'] == 0){echo 'N/A';}else{ echo $row_theatres['telephone']; } ?></a> </td>
								</tr>
								<tr height="10"></tr>
							</table>
