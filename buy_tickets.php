<?php
    ...
    $sql_temp = "SELECT * FROM tbl_booking_temp";
    ...
    if($rowCount_temp > 0){
        while($row_temp=mysqli_fetch_array($query_temp)){        
            ...
            $sql_temp_delete = "DELETE FROM tbl_booking_temp WHERE `timestamp` = '{$row_temp['timestamp']}'";
...
<html lang="en">
  ...
  <body id="itemid-7">
    ...
    <div class="buy-tickets" >
        <!--Movie Banner-->
        <div class="movie_banner" id="movie_banner" style="display:flex;justify-content:center;">
            <?php 
            if($movieID!=''){
                echo '<img src="'.$row['banner'].'" height="450"/>';
            }else{
                        ...
                        <div class="date-container">
                            <ul class="list-inline">
                                ...
                                while (strtotime($date) <= strtotime("+6 days", strtotime($startingDate))) {
                                    ...
                                    echo '<li class="datepicker" id = "date-'.$i.'" dateValue = "'.$date.'">';
