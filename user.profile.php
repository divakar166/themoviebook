...
<html lang="en">
    <head>
        ...
        <title>theMovieBook - <?php echo $user_row['first_name'];?> | Profile</title>
        ...
        <div class="container mt-3" style="background:#FFF;padding-bottom:15px; max-width:800px">
            ...
            <form id="user_profile_details" style="margin:10px 15px 0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="mobile" placeholder="Mobile" value="<?php echo $user_row['mobile'] ?>" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
                ...
                <div class="modal-body">
                    <form id="edit_user_profile_form">
                        ...
                        <div class="form-group row" style="margin-bottom:0;">
                            <label class="col-sm-4 col-form-label">Mobile:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="mobile" id="mobile" pattern="{10}" placeholder="Mobile" value="<?php echo $user_row['mobile'] ?>">
                            </div>
                        </div>
                    </form>
                </div>
