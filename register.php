...
<html lang="en">
  ...
  <body>
    ...
    <div class="register" style="padding-bottom:40px;margin-top:5rem;">
      
      <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
        <h2 style="font-weight:normal; color: #3f3545; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size:48px; margin-bottom:10px; padding-top:15px; text-align:center;">Register with theMovieBook</h2>
        <hr/> 
