  ...
  <body>
    ...
    <div class="privacy_policy">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            ...
            <div>
              <p> (Web based online tickets reservation solution of theMovieBook (Pvt) Limited.) is committed to maintaining the confidentiality, integrity and security of any personal information of our website users. We are proud of the strength of our site security and want you to know how we protect your information and use it. <br /><br /> stresses its privacy and security standards to guard against identity theft and provide security for your account information and other data. We constantly re-evaluate our privacy and security policies and adapt them as necessary to deal with new challenges.</p>
              <p>&nbsp;</p>
              <p style="font-size: 18px;">Your Privacy is not for sale</p>
              <p>&nbsp;</p>
              <p>We at  will not sell or rent your personal information to anyone, at any time or for any reason.</p>
              <p>&nbsp;</p>
              <p style="font-size: 18px;">We limit the collection and use of personal information</p>
              <p style="font-size: 18px;"> </p>
              <p>In order to sing-up as a member of , you need to provide us with a Login ID, a valid email address and a password.  makes every effort to allow you to retain the anonymity of your personal identity and you are free to choose your Login ID, any valid email address and password that keeps your personal identity anonymous.</p>
              ...
              <p>All information of personal nature, such as Name, NIC Number, and Contact Number etc are only needed in order to operate, develop or improve the service we provide.  requires the above mainly for the following circumstances:</p>
              <ul class="page_bullet">
              <li>To become a member of </li>
              <li>To verify the authenticity of the ticket holder</li>
              <li>To register for any  newsletter/ and receive SMS based ticket confirmations / promotions. Note that SMS will only be sent to consented parties to which the service is subscribed for.</li>
              ...
              <p style="font-size: 18px;"> </p>
              <p>theMovieBook () uses your Personal Identity Information only for the following:</p>
              <ul class="page_bullet">
              <li>to analyze site usage and improve our service;</li>
              <li>to deliver to you any administrative notices, alerts and communications relevant to your use of theMovieBook () requires;</li>
              ...
              <li>to enforce theMovieBook () requires Terms of Use; and</li>
              <li>Any item / items set forth in this Privacy and Security Policy.</li>
              </ul>
              <p>In the event that your access to  was brought to you by one of our partners, through a partner URL, your email address and other registration /access information used for registration to , may be provided to such a partner.<br /><br /></p>
              <p style="font-size: 18px;">Account Information will not be disclosed</p>
              <p><br /> does not disclose your Personal Information and may disclose information and data only in a non-personally identifiable manner to: <br /><br /></p>
              <ul class="page_bullet">
              <li>Advertisers and other third parties for their marketing and promotional purposes;</li>
              <li>Organizations approved by  who conduct research into consumer spending.</li>
              ...
              <p><br />If your Personal Identity information changes, during your subscription to , you may update your profile online.<br /><br /></p>
              <p style="font-size: 18px;">Contact us if you have any questions or concerns</p>
              <p>If you have questions, comments, concerns or feedback regarding this Privacy and Security Policy, send an e-mail to <a style="color:#ee1a03; text-decoration:none" href="mailto:themoviebook91@gmail.com">support@themoviebook.com</a><br/><br/><br/></p>
            </div>
        </div>
    </div>
