...
<html lang="en">
  ...
  <body>
    ...
    <div class="rates_and_showtimes" style="margin-top:5rem;">
        ...
        <div class="container mt-4">
                ...
                <p>
                    Please select the required movie and the theatre from the dropdown lists and it will display current ticket rates and show times for the relevant theatre.
                    <br>
                    <strong>Note:</strong>
                    <br>	
