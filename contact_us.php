...
<html lang="en">
  ...
  <body>
    ...
    <div class="contact_us" style="padding-bottom:35px;margin-top:4.5rem;">

        <div class="container" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            <h2 style="font-weight:normal; color: #3f3545; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size:48px;text-align:center;margin:0;">Contact theMovieBook</h2>
            
            <div>
				<p style="text-align:center;margin:0;"><b>If you wish to contact us via email please fill in the following form and we will get in touch with you at the earliest.</b></p>
							...
							<form id="contactForm" method="post">
									...
									<div class="form-group">
										<span>Phone Number</span>        
											<input type="text" class="form-control required" name="phone" id="phone" pattern="[6-9][0-9]{9}" maxlength="10" style="max-width:445px;" value="" required/>        
									</div> 
									<div class="form-group">
