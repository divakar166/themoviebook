    ...
    <div class="container">
        <div class="row">
            ...
            <div class="footer_left">
                <img src="images/footer_logo.png" width="268px" height="49px" class="img-responsive" alt="theMovieBook Logo">
                <p> © 2020 theMovieBook. All Rights Reserved. Site by <span class="company_name"><a href="#" style="text-decoration:none;">Divakar Singh</a></span></p>
            </div>
            </div>
        </div>
