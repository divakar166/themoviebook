...
if(isset($_SESSION['payment'])) {
    if($_SESSION['totalTicketCount'] > 0) {
        ...
        <div style="margin:0px;">'.$_SESSION['theatreName'].' - '.$_SESSION['theatreCity'].'</div>
...
<div class="content">
    ...
    <hr>
    <div style="margin-bottom:15px; color:#5c5c5c">Your browser will automatically redirect to theMoviesBook homepage in <span id="timer" style="font-weight:bold"></span> seconds.</div>
    <p>
